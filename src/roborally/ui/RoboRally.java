...
public class RoboRally<Board, Robot, Wall, Battery, RepairKit, SurpriseBox> extends JFrame {
	...
	public static void main(String[] args) {
		...
		/* <begin> */
		RoboRally<roborally.board.Board, roborally.model.dynamicObject.Robot, roborally.model.staticObject.Wall, roborally.model.inventory.item.Battery, roborally.model.inventory.item.RepairKit, roborally.model.inventory.item.SurpriseBox> roboRally 
		= new RoboRally<roborally.board.Board, roborally.model.dynamicObject.Robot, roborally.model.staticObject.Wall, roborally.model.inventory.item.Battery, roborally.model.inventory.item.RepairKit, roborally.model.inventory.item.SurpriseBox>(new roborally.facade.Facade());
		/* <end> */
