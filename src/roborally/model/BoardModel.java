...
public abstract class BoardModel implements Terminatable{
	...
	/**
	 * Returns the coordinate at the given dimension of this board model.
	 * 
	 * @param 	dimension
	 * 			The dimension of the coordinate that has to be returned
	 * 			for this board model.
	 * @return	Returns the coordinate at the given dimension
	 * 			of the position of this board model.
	 * 			| result == getPosition().getCoordinate(dimension)
	 * @throw	IllegalStateException
	 * 			The position refers the null reference.
	 * 			| getPosition() == null
	 ...
	 */
	@Raw
	public long getCoordinate(Dimension dimension)
			throws IllegalDimensionException, IllegalStateException{
		if (getPosition()==null)
			throw new IllegalStateException("This board model's position refers the null reference.");
		return getPosition().getCoordinate(dimension);
	}
	
	/**
	 * Returns the coordinates of this board model.
	 * 
	 * @return  Returns the coordinates of this board model.
	 * 			| result == getPosition().getCoordinates()
	 * @throw	IllegalStateException
	 * 			The position refers the null reference.
	 * 			| getPosition() == null
	 */
	...
	/**
	 * Checks if this board model could be hit.
	 * 
	...
	/**
	 * Hits this board model because of a fired shot.
	 * 
	 * @throws	IllegalStateException
	 * 			This board model can not be hit.
	 * 			| !canBeHit()
	 */
